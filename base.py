...
class BaseTrack(BaseSingleAgentAviary):
    """Single agent RL problem: Race around the track."""
    ...
    def __init__(self,
        ...
        self.drone_idle = 0
        self.prev_pos = np.array(self._getDroneStateVector(0)[0:3])
    ...
    def _computeDone(self):
        ...
        """
        # timeout or drone hasn't moved in 10 time steps
        pass
